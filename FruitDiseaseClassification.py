...
fruits_disease = ['Black spot', 'Canker', 'Greening', 'healthy', 'scab', 'Anthracnose', 'Leprosis', 'Melanose', 'Mold']
...
font = ('times', 16, 'bold')
title = Label(main, text='DETECTION AND CLASSIFICATION OF FRUIT DISEASES')
